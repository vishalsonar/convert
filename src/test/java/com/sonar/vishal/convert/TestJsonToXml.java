...
public class TestJsonToXml {
	...
	public TestJsonToXml() {
		convert = new Convert();
	}

	/**
	 * Common code to test convertible xml
	 */
	private void commonTest() {
		String xmlString = new Convert().toXml(json);
	...
	/**
	 * Test to Convert simple Json string to xml string Test to Convert Json with
	 * object string to xml string Test to Convert Json with inner object string to
	 * xml string Test to Convert Json with array object string to xml string Test
	 * to Convert Json with array string to xml string Test to Convert Json with
	 * array of array string to xml string Test to Convert complex json to xml
	 * string Test to Convert json with root array to xml string Test to Convert
	 * json with empty value to xml string
	 */
	@Test
	public void toXml1() {
